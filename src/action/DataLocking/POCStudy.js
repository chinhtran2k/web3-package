...
exports.POCStudy = void 0;
var config_1 = require("../../config");
var utils_1 = require("../../utils");
var decodeLogs = require("abi-parser-pack").decodeLogs;
var POCStudy = /** @class */ (function () {
    function POCStudy(connection) {
        this.connection = connection;
        this.pcoStudy = new this.connection.web3.eth.Contract(config_1.CONFIG.POCStudy.abi, config_1.CONFIG.Patient.address);
        this.claimHolder = new this.connection.web3.eth.Contract(config_1.CONFIG.ClaimHolder.abi);
    }
    POCStudy.prototype.mintPOCStudy = function (uri, level, privateKey) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        nonce = _a.sent();
                        abiMint = this.pcoStudy.methods.mint(uri, level).encodeABI();
    ...
    POCStudy.prototype.getRootHashPOCPatient = function () {
        return __awaiter(this, void 0, void 0, function () {
            var RootHashPOCPatient;
            return __generator(this, function (_a) {
                RootHashPOCPatient = this.pcoStudy.methods.getRootHashPOCPatient().call();
                return [2 /*return*/, RootHashPOCPatient];
            });
        });
    };
    POCStudy.prototype.getRootNodeIdPOCPatient = function () {
        return __awaiter(this, void 0, void 0, function () {
            var RootNodeIdPOCPatient;
            return __generator(this, function (_a) {
                RootNodeIdPOCPatient = this.pcoStudy.methods.getRootNodeIdPOCPatient().call();
