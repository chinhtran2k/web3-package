...
var Patient = /** @class */ (function () {
    function Patient(connection) {
        this.connection = connection;
        this.patient = new this.connection.web3.eth.Contract(config_1.CONFIG.Patient.abi, config_1.CONFIG.Patient.address);
        this.claimHolder = new this.connection.web3.eth.Contract(config_1.CONFIG.ClaimHolder.abi);
    }
    Patient.prototype.mintPatient = function (patientDID, uri, privateKey) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abiMintExecute = this.claimHolder.methods.execute(config_1.CONFIG.ClaimHolder.address, 0, abiMint).encodeABI();
    ...
    Patient.prototype.getPatientRootHashValue = function (patientDID) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Patient.prototype.getListRootHashValue = function () {
        return __awaiter(this, void 0, void 0, function () {
